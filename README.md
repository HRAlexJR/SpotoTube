...
2. Set "Redirect URI" to `http://localhost:8888/callback`
   ![Spotify create new app](resources/spotify_create_app.png)
3. Copy the "Client ID" and "Client Secret" to use later
   ![Spotify settings](resources/spotify_settings.png)
   ![Spotify credentials](resources/spotify_credentials.png)
